...
seq2 = {gmSEQ.halfpi, gmSEQ.m + t1, 'X_DEER', t1 + gmSEQ.m, gmSEQ.halfpi,...
    wait1, gmSEQ.pi, wait1,...
    gmSEQ.halfpi, gmSEQ.m + t1, 'X_DEER', t1 + gmSEQ.m, gmSEQ.halfpi};

ch = complieCHN({seq1, seq2});
uploadSimpleProg('f_DEER_scan_tau', ch);
